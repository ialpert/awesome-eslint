...
- [BrightScript](https://github.com/RokuRoad/eslint-plugin-roku) - Plugin to lint BrightScript files for Roku channels. Produces ESTree 'like' AST for easier rules migration
